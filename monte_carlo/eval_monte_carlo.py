...
fig00.suptitle('Refractive Correction: Based on Patient 1 and 2', fontsize=16)
...
for k in dir_list:
    ...
    ax00.plot(t[index_prestr:] / 3600, power_eye[index_prestr:] - power_eye[index_prestr])  # , label=k[5:])
...
ax00.errorbar([8+15/60], [-2.25*0.475], yerr=[2.25*0.275], color='black', lw=1.2, fmt='o')
ax00.errorbar([16], [-2.25*0.28], yerr=[2.25*0.15], color='black', lw=1.2, fmt='o')
